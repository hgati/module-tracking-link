<?php
namespace Hgati\TrackingLink\Plugin\Config\Model\Config\Structure\Element;
...
class Group
{
    ...
    {
        if ($data['id'] == 'service_url' && $data['path'] == 'hgati_tracking') {
    ...
    protected function getFieldData($code, $title)
    {
        return [
            ...
            'path' => 'hgati_tracking/service_url',
            '_elementType' => 'field'
        ];
    }
